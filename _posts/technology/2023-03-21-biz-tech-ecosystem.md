...
## 构建一个技术生态：需要 cli(工具链：编译、调试、打包)、ide(ui组件预览编辑、游戏界面预览)、引擎(ui渲染器、代码执行器)
...
依赖于 react native 或者 flutter 的完整生态，是可以在其基础上扩展出 cocos 和快应用，定制自己的渲染器、ui 组件、ide游戏预览。react native基于skina的自渲染：https://shopify.github.io/react-native-skia/docs/getting-started/installation
