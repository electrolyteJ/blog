...
```
直播与点播的区别在于EXT-X-ENDLIST，其表示了该m3u8文件有结尾，不会在向服务器请求下一个m3u8文件。直播server端代码已经实现，可以参考这个项目[JamesfChen/river](https://github.com/JamesfChen/river/blob/master/server4py/app/http_ts/server.py)
