...
### react native
- react native 引擎: https://github.com/react/react-native
- react native cli https://github.com/react-native-community/cli

### flutter
- flutter sdk(引擎、cli): https://github.com/flutter/flutter
...
### godot
- godot引擎： https://github.com/godotengine/godot
- godot cli: https://docs.godotengine.org/zh-cn/4.x/tutorials/editor/command_line_tutorial.html
- godot ide: https://github.com/godotengine/godot

新时代的编程范式发生了变化古法编程-> ai coding，技术生态需要补齐coding agent的 skill/mcp/cli 这些工具接口，才能让 ai 使用，ide不再是写代码的主战场，退而成review 代码。
依赖于 react native 或者 flutter 的完整生态，是可以定制自己的渲染器、ui 组件、ide游戏预览。

- expo-three 游戏引擎 + threejs editor
- expo babylonjs 游戏引擎 + babylonjs editor
- react native基于skina的自渲染：https://shopify.github.io/react-native-skia/docs/getting-started/installation
- flutter flame游戏引擎: https://docs.flame-engine.org/latest/README.html
